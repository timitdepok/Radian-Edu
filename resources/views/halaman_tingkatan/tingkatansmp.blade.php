...
{{-- navbar section end --}}
      ...
      <div class="container">
          <div class="w-full px-4 mb-10">
              <div class="max-w-xl mx-auto text-center">
                  <h3 class="font-semibold lg:text-5xl text-2xl text-primary mb-0 pt-16">ALUMNI RADIAN</h3>
          ...
          <div class="flex">
            ...
            <div id="slidercarousel" class="w-full overflow-hidden">
                <ul id="slids" class="flex w-full">
                    <li class="mr-3">
                        <img src="img/smp-1.jpg" alt="" class="h-auto w-full">
                    </li>
                    <li class="mr-3">
                        <img src="img/smp-2.png" alt="" class="h-auto w-full">
                    </li>
                    <li class="mr-3"> 
                        <img src="img/smp-3.png" alt="" class="h-auto w-full">
                    </li>
                    <li class="mr-3">
                        <img src="img/smp-1.jpg" alt="" class="h-auto w-full">
                    </li>
        ...
        <div class="container">
            <div class="w-full px-4">
                <div class="max-w-full mx-auto text-center mb-16">
                    <h1 class="lg:text-5xl text-2xl font-semibold text-primary pb-1">APA SAJA KEUNGGULAN RADIAN?</h1>
    ...
    <section id="#" class="pt-16 bg-slate-100">
      <div class="container">
        <div class="w-full px-4">
          <div class="max-w-full mx-auto text-center mb-16">
            <h2 class="font-semibold lg:text-5xl text-2xl mb-1 text-primary">KENAPA HARUS RADIAN?</h2>
      ...
      <div class="container">
        <div class="w-full px-4 mb-10">
          <div class="max-w-full mx-auto text-center">
            <h3 class="font-semibold lg:text-5xl text-2xl text-primary mb-0 pt-16">SAAT BELAJAR DI RADIAN</h3>
        ...
        <div class="flex">
          <div id="sliderContainer" class="w-full overflow-hidden">
            <ul id="slider" class="flex w-full">
                ...
                <li class="mr-3">
                    <img src="img/testismp-2.png" alt="" class="h-auto w-full">
                </li>
                <li class="mr-3">
                    <img src="img/testismp-3.png" alt="" class="h-auto w-full">
                </li>
                <li class="mr-3">
                    <img src="img/testismp-1.png" alt="" class="h-auto w-full">
                </li>
      ...
      <div class="container">
        <div class="w-full px-4 mb-10">
          <div class="max-w-full mx-auto text-center">
            ...
            <h1 class="lg:text-5xl text-2xl font-semibold text-black mt-1 mb-2">Pilih Sesinya Sekarang, Yuk</h1>
