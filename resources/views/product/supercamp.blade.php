...
<header class="bg-white absolute top-0 left-0 w-full flex items-center z-10">
    <div class="container">
        <div class="flex items-center justify-between relative">
            <div class="px-4">
                <a href="home/halaman_utama.blade.php" class="py-6">
            ...
            <nav id="nav-menu" class="hidden absolute py-5 bg-white
                ...
                <ul class="block lg:flex">
                    ...
                    <li class="group">
                        <button class="text-base text-white font-medium py-2 px-3 mx-8 border bg-primary rounded-lg"><a href="https://wa.me/+6281779007135?text=Halo%20radian%20%0A%0ANama%20%3A%20%0AAsal%20Kota%20%3A%20%0ASekolah%20dan%20Kelas%20%3A%20%0AOrang%20Tua%20%2F%20Siswa%20%3F%20%3A%0ASaya%20mengetahui%20program%20ini%20melalui%20website%20supercamp%20">KONSULTASI</a></button>
                    </li>
                </ul>
            </nav>
            </div>
...
<script src="{{asset('/js/supercamp.js')}}"></script>ipt>
