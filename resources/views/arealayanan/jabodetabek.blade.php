        ...
        <div class="lg:pl-9 overflow-hidden bg-hero rounded-3xl">
            <div class="grid items-center grid-cols-1 gap-y-2 lg:grid-cols-2 lg:order-1 order-2">
                <div class="lg:pl-9 px-2 max-w-3xl lg:mt-0 mt-3">
                    <h1 class="lg:text-5xl text-2xl font-semibold text-primary mb-6">BEST PARTNER FOR ACCELERATING YOUR GROWTH</h1>
                ...
                <div class="relative p-0 lg:order-2 order-1">
            ...
            <div class="flex">
                ...
                <div class="flex flex-wrap mx-auto self-center text-center">
                    <div class="w-full">
                        ...
                        <h1 class="lg:text-4xl text-lg font-semibold text-black mb-3 lg:max-w-2xl">Tunggu apalagi segera dapatkan Diskon Up To 30% sampai Tanggal 30 September 2022</h1>
